...
export default function UserProfile() {
  ...
  return (
    <LayoutUser>
      ...
      <Row style={{ marginTop: "15px" }}>
        <Col sm={3} style={{ textAlign: "center" }}>
          <Image
            ...
            style={{ objectFit: "cover",marginLeft:"50px",marginTop:"10px", borderRadius: "5%",height:'90%',width:'90%' }}
          />
        </Col>
        <Col></Col>
        <Col sm={7}>
      ...
      <Row style={{ backgroundColor: "#034ea2", marginRight: "8%", borderRadius: "12px" }}>
